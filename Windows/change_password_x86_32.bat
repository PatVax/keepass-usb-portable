...
:OLD_PASSWORD
	...
	%sfp%x86_32\AESCrypt\aescrypt.exe -p "%pass_old%" -d %sfp%portable_appdata\Syncthing\config.xml.aes
...
:ENCRYPT
	...
	%sfp%x86_32\AESCrypt\aescrypt.exe -p "%pass_new%" -e %sfp%portable_appdata\Syncthing\config.xml
